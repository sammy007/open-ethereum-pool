...
func TestCalculateRewards(t *testing.T) {
	blockReward, _ := new(big.Rat).SetString("314000000000000000000")
	...
	expectedTotalAmount := int64(314000000000)
...
func TestChargeFee(t *testing.T) {
	orig, _ := new(big.Rat).SetString("314000000000000000000")
	value, _ := new(big.Rat).SetString("314000000000000000000")
	expectedNewValue, _ := new(big.Rat).SetString("235500000000000000000")
	expectedFee, _ := new(big.Rat).SetString("78500000000000000000")
